# AGENTS.md - Kagi Configuration Management Library

## Commands
- Test: `mix test` (run all tests), `mix test test/kagi_test.exs` (single test file)
...
- Core module: `Kagi` (GenServer at `/lib/kagi.ex`) 
- Application supervision: `Kagi.Application` starts main GenServer
...
- Configuration reload: `Kagi.reload/0` and `Kagi.reload/1` for dynamic config updates
