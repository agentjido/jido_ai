...
- `Jido.AI.Actions.LLM.Chat`
  ...
  - Runnable example: [`lib/examples/scripts/demo/actions_llm_runtime_demo.exs`](https://github.com/agentjido/jido_ai/blob/v2.0.0-beta/lib/examples/scripts/demo/actions_llm_runtime_demo.exs)
- `Jido.AI.Actions.LLM.Complete`
...
- `Jido.AI.Actions.ToolCalling.CallWithTools`
  ...
  - Runnable example: [`lib/examples/scripts/demo/actions_tool_calling_runtime_demo.exs`](https://github.com/agentjido/jido_ai/blob/v2.0.0-beta/lib/examples/scripts/demo/actions_tool_calling_runtime_demo.exs)
- `Jido.AI.Actions.ToolCalling.ExecuteTool`
...
- `Jido.AI.Actions.Planning.Plan`
  ...
  - Runnable example: [`lib/examples/scripts/demo/actions_planning_runtime_demo.exs`](https://github.com/agentjido/jido_ai/blob/v2.0.0-beta/lib/examples/scripts/demo/actions_planning_runtime_demo.exs)
- `Jido.AI.Actions.Planning.Decompose`
...
- `Jido.AI.Actions.Retrieval.UpsertMemory`
  ...
  - Runnable example: [`lib/examples/scripts/demo/actions_retrieval_runtime_demo.exs`](https://github.com/agentjido/jido_ai/blob/v2.0.0-beta/lib/examples/scripts/demo/actions_retrieval_runtime_demo.exs)
- `Jido.AI.Actions.Retrieval.RecallMemory`
...
- `Jido.AI.Actions.Quota.GetStatus`
  ...
  - Runnable example: [`lib/examples/scripts/demo/actions_quota_runtime_demo.exs`](https://github.com/agentjido/jido_ai/blob/v2.0.0-beta/lib/examples/scripts/demo/actions_quota_runtime_demo.exs)
- `Jido.AI.Actions.Quota.Reset`
...
- `Jido.AI.Actions.Reasoning.Analyze`
  ...
  - Runnable example: [`lib/examples/scripts/demo/actions_reasoning_runtime_demo.exs`](https://github.com/agentjido/jido_ai/blob/v2.0.0-beta/lib/examples/scripts/demo/actions_reasoning_runtime_demo.exs)
- `Jido.AI.Actions.Reasoning.Infer`
