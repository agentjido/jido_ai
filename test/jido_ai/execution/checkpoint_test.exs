defmodule Jido.AI.Execution.CheckpointTest do
  use ExUnit.Case, async: true
  alias Jido.AI.Execution.Checkpoint
  ...
  defp native do
    %{
      profile: %{memory: %{history: :context}, effect_policy: %{}, reasoning: %{effect_policy: %{}}},
      options: [callback: fn x -> x end],
      effect_plan:
        Jido.AI.Effects.Candidate.new(%{
          context: Jido.Session.new(),
