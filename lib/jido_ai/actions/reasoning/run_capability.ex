defmodule Jido.AI.Actions.Reasoning.RunCapability do
  ...
  The Plugin supplies the validated Profile and result field.
  ...
  def run(params, %{agent_state: _} = context) do
    case Jido.AI.Capability.prepared_reasoning(context) do
      %{profile: %Jido.AI.Profile{}} = binding ->
        Jido.AI.Capability.run(Jido.AI.Actions.Reasoning.RunStrategy, params, context, binding)
