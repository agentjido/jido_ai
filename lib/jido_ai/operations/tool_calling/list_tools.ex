defmodule Jido.AI.Actions.ToolCalling.ListTools do
  ...
  * `include_schema` (optional) - Include tool schemas (default: `true`)
  ...
  defp normalize_tools_to_list(tools),
    do: tools |> Jido.AI.ToolAdapter.to_action_map() |> Enum.sort_by(&elem(&1, 0))

  defp resolve_tools_input(context), do: Jido.AI.ActionInput.tools(context)
