defmodule Jido.AI.Reasoning.TRM.ACT do
  @moduledoc """
  ...
  import Jido.AI.Reasoning.TRM.Helpers, only: [clamp: 3]
  ...
  def make_decision(
        %{threshold: threshold, current_confidence: confidence, history: history},
        _latent_state
      ) do
    cond do
