defmodule Jido.AI.Context do
  ...
  **Context = List of Messages. Projection = Context + System Prompt.**
  ...
  """
  @spec append_assistant(t(), String.t() | [ContentPart.t()] | nil, list() | nil, keyword()) ::
          t()
  ...
  """
  @spec append_tool_result(t(), String.t(), String.t(), String.t() | [ContentPart.t()], keyword()) ::
          t()
  ...
  defp format_entry_for_pp(%Entry{role: :assistant, tool_calls: tool_calls})
  ...
  defp normalize_entry_content(role, content, _text_content)
       when role in [:user, :tool] and is_list(content),
  ...
  defp coerce_entry(%{} = entry) do
    ...
    explicit_thinking =
      case get_field(entry, :thinking) do
