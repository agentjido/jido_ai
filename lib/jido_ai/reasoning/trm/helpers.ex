defmodule Jido.AI.Reasoning.TRM.Helpers do
  @moduledoc """
  ...
  - `sanitize_user_input/1` - Applies the retained text filters and length limit
  ...
  @doc """
  Applies the retained prompt text filters and length limit.

  These filters do not establish a security boundary. They preserve the
  existing text conversion. This function:
