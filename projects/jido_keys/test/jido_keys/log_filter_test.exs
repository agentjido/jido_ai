defmodule JidoKeys.LogFilterTest do
  @moduledoc """
  Tests for the JidoKeys.LogFilter module.
  """

  use ExUnit.Case

  alias JidoKeys.LogFilter

  setup do
    original_config = Application.get_env(:jido_keys, JidoKeys.LogFilter, [])

    Application.put_env(:jido_keys, JidoKeys.LogFilter,
      enabled: true,
    ...
    on_exit(fn ->
      if original_config == [] do
        Application.delete_env(:jido_keys, JidoKeys.LogFilter)
      else
        Application.put_env(:jido_keys, JidoKeys.LogFilter, original_config)
      end
    end)
  ...
  describe "filter/1" do
    ...
    test "passes through messages when disabled" do
      Application.put_env(:jido_keys, JidoKeys.LogFilter, enabled: false)
  ...
  describe "configuration" do
    test "uses custom redaction text" do
      Application.put_env(:jido_keys, JidoKeys.LogFilter, redaction_text: "***HIDDEN***")
