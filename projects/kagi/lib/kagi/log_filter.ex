defmodule Kagi.LogFilter do
  ...
  ## Examples
      ...
      iex> Kagi.LogFilter.redact_secrets("API_KEY=sk-1234567890")
      "API_KEY=[REDACTED]"

      iex> Kagi.LogFilter.redact_secrets("Normal log message")
      "Normal log message"
  ...
  ## Examples
      ...
      iex> Kagi.LogFilter.redact_metadata(metadata)
  ...
  ## Examples
      ...
      iex> Kagi.LogFilter.sensitive_key?("api_key")
      true

      iex> Kagi.LogFilter.sensitive_key?(:password)
      true

      iex> Kagi.LogFilter.sensitive_key?("user_name")
      false
  ...
  ## Examples
      ...
      iex> Kagi.LogFilter.enabled?()
      true

  """
  @spec enabled?() :: boolean()
  def enabled? do
    Application.get_env(:kagi, __MODULE__, [])
  ...
  ## Examples
      ...
      iex> Kagi.LogFilter.get_redaction_text()
      "[REDACTED]"
  ...
  ## Examples
      ...
      iex> Kagi.LogFilter.configure(enabled: false)
      :ok

      iex> Kagi.LogFilter.configure(redaction_text: "***HIDDEN***")
      :ok

  """
  @spec configure(keyword()) :: :ok
  def configure(opts \\ []) do
    current_config = Application.get_env(:kagi, __MODULE__, [])
    new_config = Keyword.merge(current_config, opts)

    Application.put_env(:kagi, __MODULE__, new_config)
