# Historical public API migration map

Archived on 2026-09-15. This is a migration record, not the current API contract.
Use the [current public API map](public-api-map.md). Source paths, counts, and
pending work below describe earlier checkpoints and can be obsolete.
...
Use this map with the [historical feature map](feature-map-history.md) and the
...
The [V2 source inventory](api-inventory-v2.json) covers all 175 baseline files under `lib`.
