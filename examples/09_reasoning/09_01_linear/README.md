...
[Agent examples](agent.ex) ·
[Example tests](../../../test/examples/09_reasoning/09_01_linear/09_01_linear_test.exs)
...
```sh
mix test --include example --seed 0 test/examples/09_reasoning/09_01_linear/09_01_linear_test.exs
```
...
[09_02 example](../09_02_method_api/README.md) adds method selection and result getters,
