...
[28 example cases](../../../test/examples/09_reasoning/09_05_tot_api/09_05_tot_api_test.exs)
extend the [native ToT example](../09_04_tot/README.md). They run the public ToT API and
...
```sh
mix test --include example --seed 0 test/examples/09_reasoning/09_05_tot_api/09_05_tot_api_test.exs
```

The example cases remain excluded by default. All model replies come from
