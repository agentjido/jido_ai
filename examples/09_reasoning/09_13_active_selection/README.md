...
and [8 example cases](../../../test/examples/09_reasoning/09_13_active_selection/09_13_active_selection_test.exs)
...
The three-phase TRM case commits selection once, not once per phase. Its final
request result is the latest completed improvement; the reviewed best answer
remains available through TRM inspection.
