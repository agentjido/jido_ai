...
The [public Agent declarations](agent.ex)
and [eight example cases](../../../test/examples/09_reasoning/09_15_prompt_policy/09_15_prompt_policy_test.exs)
inspect the actual system messages sent through ReqLLM to the shared mock.
The existing [native Adaptive Agent](../09_10_adaptive/agent.ex)
supplies the native DSL and data examples.

```sh
mix test test/examples/09_reasoning/09_15_prompt_policy/09_15_prompt_policy_test.exs --include example --seed 0
```
