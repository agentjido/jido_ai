...
and [19 example cases](../../../test/examples/09_reasoning/09_12_method_controls/09_12_method_controls_test.exs)
...
on the same Agent. The TRM result is the fifth and latest completed improvement.
Native ReAct instead returns its existing control error at
...
The [09_13 follow-up](../09_13_active_selection/README.md) also restores committed active
