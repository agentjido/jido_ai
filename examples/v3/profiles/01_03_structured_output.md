...
- [Agent and repair Flow](../lib/examples/01_authoring/01_03_structured_output/agent.ex)
- [Acceptance tests](../test/examples/01_authoring/01_03_structured_output_test.exs)
...
Status: two passing integration tests. Imported schemas, attachments, result
