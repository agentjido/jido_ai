...
The [Agent modules](../lib/examples/02_requests/02_07_response_metadata/agent.ex)
and [integration tests](../test/examples/02_requests/02_07_response_metadata_test.exs)
...
```sh
mix test --include integration test/examples/02_requests/02_07_response_metadata_test.exs
```
