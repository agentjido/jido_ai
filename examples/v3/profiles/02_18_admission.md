...
The [Agent examples](../lib/examples/02_requests/02_18_admission/agent.ex)
and [nine integration cases](../test/examples/02_requests/02_18_admission_test.exs)
use the core Agent, Router and Session Plugin. The shared model server records
each HTTP request.

```sh
mix test --include integration test/examples/02_requests/02_18_admission_test.exs
```
