...
The [Agent example](../lib/examples/16_capabilities/16_03_routing_policy/agent.ex)
...
[integration suite](../test/examples/16_capabilities/16_03_routing_policy_test.exs)
...
```sh
mix test test/examples/16_capabilities/16_03_routing_policy_test.exs --include integration --seed 0
```
...
the 21 integration cases. Integration exclusion is not passing evidence.
