...
[Agent](../lib/examples/02_requests/02_21_context_views/agent.ex) and
[tests](../test/examples/02_requests/02_21_context_views_test.exs) use the
...
```sh
mix test test/examples/02_requests/02_21_context_views_test.exs --include integration
```
