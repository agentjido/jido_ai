...
The [native and public Agents](../lib/examples/09_reasoning/09_16_reasoning_tool/agent.ex)
expose `Jido.AI.Actions.Reasoning.RunStrategy` directly as a model tool. The
[ten integration cases](../test/examples/09_reasoning/09_16_reasoning_tool_test.exs)
use the shared HTTP/SSE mock and real core Exec, Agent and Session work.

```sh
mix test test/examples/09_reasoning/09_16_reasoning_tool_test.exs --include integration --seed 0
```
