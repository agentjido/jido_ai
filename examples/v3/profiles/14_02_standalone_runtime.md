...
[Example](../lib/examples/14_resume/14_02_standalone_runtime/agent.ex) and
[tests](../test/examples/14_resume/14_02_standalone_runtime_test.exs) call the
...
[14_03](14_03_checkpoint_resume.md) now proves native model and complete-tool-round
...
The initial eighteen integration cases cover lazy start; identity; real aliased tools;
...
```sh
mix test test/examples/14_resume/14_02_standalone_runtime_test.exs --include integration
```

## Later native continuation work

[14_07](14_07_standalone_input.md) adds caller-supplied input queues.
[14_08](14_08_query_append.md) adds query append for initial State and native
...
Six added cases bring this file to 24 integration cases. Standalone callers
