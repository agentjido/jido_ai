...
[Agent examples](../lib/examples/16_capabilities/16_01_reasoning/agent.ex) and
[integration tests](../test/examples/16_capabilities/16_01_reasoning_test.exs)
...
```sh
mix test test/examples/16_capabilities/16_01_reasoning_test.exs --include integration --seed 0
mix test ../../test/jido_ai/plugins/reasoning --seed 0
```

There are 17 integration cases and 21 focused Plugin contract cases. Default
example runs exclude the integration cases. Excluded cases are not passing
...
and ToT retain their structured outputs. A failed run returns an error and
