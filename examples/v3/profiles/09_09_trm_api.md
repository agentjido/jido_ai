...
The [Agent examples](../lib/examples/09_reasoning/09_09_trm_api/agent.ex) and
[12 integration cases](../test/examples/09_reasoning/09_09_trm_api_test.exs)
port `use Jido.AI.TRMAgent` through the common `Jido.AI.Agent` lowerer. They use
the native TRM method from [09_08](09_08_trm.md), the same Flow, Session and mock.
...
from [09_07](09_07_got_api.md) is also open. Root dependency, package, consumer,
