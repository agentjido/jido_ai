...
The [Agent example](../lib/examples/09_reasoning/09_10_adaptive/agent.ex) and
[28 integration cases](../test/examples/09_reasoning/09_10_adaptive_test.exs)
...
The [09_11 example](09_11_adaptive_api.md) now supplies the public wrapper,
