...
The [Agent examples](../lib/examples/09_reasoning/09_11_adaptive_api/agent.ex)
and [22 integration cases](../test/examples/09_reasoning/09_11_adaptive_api_test.exs)
...
[09_12 refinement](09_12_method_controls.md) resolves the selected method's
...
[09_13 cases](09_13_active_selection.md). A new request starts without selection.
