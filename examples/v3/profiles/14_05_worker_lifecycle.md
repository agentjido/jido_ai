...
[Agents](../lib/examples/14_resume/14_05_worker_lifecycle/agent.ex) and
[tests](../test/examples/14_resume/14_05_worker_lifecycle_test.exs) use the public
...
and result formats. Run the focused set from `examples/v3`:

```sh
mix test test/examples/14_resume/14_05_worker_lifecycle_test.exs test/examples/02_requests/02_01_session_test.exs test/examples/02_requests/02_14_stream_activity_test.exs test/examples/02_requests/02_17_signal_delivery_test.exs test/examples/09_reasoning/09_02_method_api_test.exs --include integration --seed 0
```
