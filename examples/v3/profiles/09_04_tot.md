...
[Agent example](../lib/examples/09_reasoning/09_04_tot/agent.ex) ·
[Integration tests](../test/examples/09_reasoning/09_04_tot_test.exs)
...
[09_05 example](09_05_tot_api.md) ports public helpers, retained namespace
...
Run `mix test --include integration --seed 0 test/examples/09_reasoning/09_04_tot_test.exs`
from `examples/v3`. The 26
integration cases are excluded from the default run. The 18 retained Machine
