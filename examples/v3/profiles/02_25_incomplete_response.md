...
The [native Agent](../lib/examples/02_requests/02_25_incomplete_response/agent.ex)
declares its model, session, saved history and result field through `agent do`.
The [16 integration cases](../test/examples/02_requests/02_25_incomplete_response_test.exs)
...
```sh
mix test test/examples/02_requests/02_25_incomplete_response_test.exs --include integration
```
