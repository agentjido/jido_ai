...
[Agent example](../lib/examples/09_reasoning/09_03_aot/agent.ex) ·
[Integration tests](../test/examples/09_reasoning/09_03_aot_test.exs) ·
[Default lifecycle case](../test/stable/aot_lifecycle_test.exs)
...
There are 25 integration cases, excluded by default. The port of the
...
```sh
mix test test/stable/aot_lifecycle_test.exs
mix test --include integration test/examples/09_reasoning/09_03_aot_test.exs
