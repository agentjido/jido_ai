...
The [Agent, Action and Flow](../lib/examples/03_tools/03_03_numeric_inputs/agent.ex)
and [four integration cases](../test/examples/03_tools/03_03_numeric_inputs_test.exs)
...
```sh
mix test --include integration test/examples/03_tools/03_03_numeric_inputs_test.exs
```
