...
The [Agents and tools](../lib/examples/02_requests/02_10_tool_effects/agent.ex)
and [24 integration tests](../test/examples/02_requests/02_10_tool_effects_test.exs)
use real core Actions, Agent commits, Dispatch and Scheduler Plugins, a local
file and the shared HTTP mock.

```sh
mix test --include integration test/examples/02_requests/02_10_tool_effects_test.exs
```
