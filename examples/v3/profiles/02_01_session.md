...
- [Agent](../lib/examples/02_requests/02_01_session/agent.ex)
- [Integration tests](../test/examples/02_requests/02_01_session_test.exs)
- [Fresh-runtime tool case](../specs/unloaded_tool_session.exs)
...
The [09_07 example](09_07_got_api.md) makes busy rejection consistent across
