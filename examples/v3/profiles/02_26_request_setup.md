...
The [Agent examples](../lib/examples/02_requests/02_26_request_setup/agent.ex)
...
The [six integration cases](../test/examples/02_requests/02_26_request_setup_test.exs)
use the shared HTTP/SSE server and actual ReqLLM execution.

```sh
mix test test/examples/02_requests/02_26_request_setup_test.exs --include integration
```
