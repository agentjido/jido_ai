...
The [Agent examples](../lib/examples/09_reasoning/09_07_got_api/agent.ex) and
[11 integration cases](../test/examples/09_reasoning/09_07_got_api_test.exs)
connect public GoT authoring and inspection to the
[native graph method](09_06_got.md). The macro now supplies method settings to
...
```sh
mix test --include integration --seed 0 test/examples/09_reasoning/09_07_got_api_test.exs
```
