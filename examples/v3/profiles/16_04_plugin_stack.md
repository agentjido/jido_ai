...
The [Agent examples](../lib/examples/16_capabilities/16_04_plugin_stack/agent.ex)
use the public ReAct and CoT macros. Their
[integration tests](../test/examples/16_capabilities/16_04_plugin_stack_test.exs)
exercise real Agent calls, callable reasoning, optional stores and the shared
HTTP mock. Run the 18 integration cases with:

```sh
mix test test/examples/16_capabilities/16_04_plugin_stack_test.exs --include integration --seed 0
```
