...
[Agent example](../lib/examples/09_reasoning/09_02_method_api/agent.ex) ·
[Integration tests](../test/examples/09_reasoning/09_02_method_api_test.exs)
...
keeps the corrections recorded in [09_01](09_01_linear.md).
...
Run the seven integration cases and 27 retained Machine tests:

```sh
mix test --include integration --seed 0 test/examples/09_reasoning/09_02_method_api_test.exs ../../test/jido_ai/chain_of_thought/machine_test.exs
```
