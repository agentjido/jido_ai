...
[Example](../lib/examples/14_resume/14_03_checkpoint_resume/agent.ex),
[new-VM script](../lib/examples/14_resume/14_03_checkpoint_resume/resume_vm.exs)
and [tests](../test/examples/14_resume/14_03_checkpoint_resume_test.exs) use the
...
Seventeen integration cases prove both boundaries, pending-tool permission,
...
```sh
mix test test/examples/14_resume/14_03_checkpoint_resume_test.exs --include integration --seed 0
```
