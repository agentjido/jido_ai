...
The [Agent modules](../lib/examples/02_requests/02_08_error_contract/agent.ex)
and [15 integration tests](../test/examples/02_requests/02_08_error_contract_test.exs)
...
```sh
mix test --include integration test/examples/02_requests/02_08_error_contract_test.exs
```
