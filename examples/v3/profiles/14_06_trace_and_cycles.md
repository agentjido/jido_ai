...
[Agent](../lib/examples/14_resume/14_06_trace_and_cycles/agent.ex) and
[tests](../test/examples/14_resume/14_06_trace_and_cycles_test.exs) use the real
native Flow, Session, provider decoder and tools. The shared MockLLM server
supplies all model responses. The 13 cases are integration tests, excluded by
default and run with `--include integration`.
...
```sh
mix test --include integration --seed 0 test/examples/14_resume/14_06_trace_and_cycles_test.exs test/examples/14_resume/14_03_checkpoint_resume_test.exs test/examples/14_resume/14_05_worker_lifecycle_test.exs test/examples/02_requests/02_07_response_metadata_test.exs test/examples/02_requests/02_12_tool_callbacks_test.exs
```
