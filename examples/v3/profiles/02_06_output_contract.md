...
The [Agent modules](../lib/examples/02_requests/02_06_output_contract/agent.ex)
and [19 integration tests](../test/examples/02_requests/02_06_output_contract_test.exs)
...
```sh
mix test --include integration test/examples/02_requests/02_06_output_contract_test.exs
```
...
- DSL, data, Builder and source JSON preserve observation flags. Disabling
  ...
  verified in [02_15](02_15_early_tool_activity.md).
