...
[Agents and provider](../lib/examples/18_skills/18_01_skill_runtime/agent.ex) and
[27 integration cases](../test/examples/18_skills/18_01_skill_runtime_test.exs)
...
[18_02](18_02_skill_authoring.md) adds `agent_skills`, automatic tools/index
...
Session commits the approved result and its refs. Core Thread projection keeps
...
[02_23](02_23_context_operations.md). This is not a cryptographic provenance
...
The 27 new integration cases pass. A separate command passes 293 retained
