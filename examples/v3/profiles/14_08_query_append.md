...
[Example](../lib/examples/14_resume/14_08_query_append/agent.ex) and
[tests](../test/examples/14_resume/14_08_query_append_test.exs) use the public
standalone API, its native Agent and Session, real tools and the shared MockLLM.
The 15 cases are integration tests excluded by default.
...
The focused set passes 58 checks. Run from `examples/v3`:

```sh
mix test --include integration --seed 0 test/examples/14_resume/14_08_query_append_test.exs test/examples/14_resume/14_03_checkpoint_resume_test.exs test/examples/14_resume/14_06_trace_and_cycles_test.exs test/examples/14_resume/14_07_standalone_input_test.exs
```
