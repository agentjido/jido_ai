...
- [DSL source](../specs/01_06_ai_extension.exs)
- [Acceptance tests](../test/examples/01_authoring/01_06_ai_extension_test.exs)

Four enabled integration tests prove compilation and live execution of the AI
...
AI package. Integration tests remain excluded by default.
...
and bounded runtime cases are covered by [01_07](01_07_ai_runtime.md).
