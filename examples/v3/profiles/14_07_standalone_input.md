...
[Example](../lib/examples/14_resume/14_07_standalone_input/agent.ex) and
[tests](../test/examples/14_resume/14_07_standalone_input_test.exs) use standalone
...
repair callback execute. The 13 cases are integration tests excluded by default.
...
```sh
mix test --include integration --seed 0 test/examples/14_resume/14_07_standalone_input_test.exs test/examples/02_requests/02_02_steering_test.exs test/examples/14_resume/14_03_checkpoint_resume_test.exs test/examples/14_resume/14_05_worker_lifecycle_test.exs ../../test/jido_ai/pending_input_server_test.exs
```
