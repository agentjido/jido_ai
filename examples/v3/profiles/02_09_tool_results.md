...
The [Agent modules](../lib/examples/02_requests/02_09_tool_results/agent.ex)
and [19 integration tests](../test/examples/02_requests/02_09_tool_results_test.exs)
...
```sh
mix test --include integration test/examples/02_requests/02_09_tool_results_test.exs
```
...
Tools with returned effects are not retried. The [02_10 example](02_10_tool_effects.md) now stages allowed state proposals
