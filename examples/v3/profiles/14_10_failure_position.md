...
[Example](../lib/examples/14_resume/14_10_failure_position/agent.ex) and
[tests](../test/examples/14_resume/14_10_failure_position_test.exs) use the real
standalone Agent, Session, tools and shared MockLLM. The 18 integration cases
...
[explicit State conversion](14_09_state_migration.md) and external evidence for
