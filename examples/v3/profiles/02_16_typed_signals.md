...
The [Agents and Actions](../lib/examples/02_requests/02_16_typed_signals/agent.ex)
and [18 integration tests](../test/examples/02_requests/02_16_typed_signals_test.exs)
...
```sh
mix test --include integration test/examples/02_requests/02_16_typed_signals_test.exs
```
...
The [02_17 example](02_17_signal_delivery.md) adds automatic session delivery,
