...
The [Agent and outbound Plugin](../lib/examples/02_requests/02_17_signal_delivery/agent.ex)
and [26 integration tests](../test/examples/02_requests/02_17_signal_delivery_test.exs)
...
```sh
mix test --include integration test/examples/02_requests/02_17_signal_delivery_test.exs
```
