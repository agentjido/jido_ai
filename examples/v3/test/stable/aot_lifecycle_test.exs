defmodule JidoAI.Examples.StableAoTLifecycleTest do
  # Port of the default AoT lifecycle case retained by PRs 231 and 309.
  # This one historical case stays in the default suite. New cases use :integration.
  ...
  test "AoT emits request started/completed signals and request telemetry" do
    ...
    assert_receive {:linear_telemetry, [:jido, :ai, :request, :start], _,
                    %{request_id: ^request_id, strategy: :aot}},
                   2_000
