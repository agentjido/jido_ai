...
The [Agent modules](agent.ex) use
the production `Jido.AI.Agent` macro. The
[11 example tests](../../../test/examples/02_requests/02_03_public_agent/02_03_public_agent_test.exs)
use one mock HTTP server and real core Agent, Flow, Exec, and tool work.

```sh
mix test --include example test/examples/02_requests/02_03_public_agent/02_03_public_agent_test.exs
```
