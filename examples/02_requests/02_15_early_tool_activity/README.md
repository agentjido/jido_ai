...
The [Agent and document Action](agent.ex)
and [13 example tests](../../../test/examples/02_requests/02_15_early_tool_activity/02_15_early_tool_activity_test.exs)
...
```sh
mix test --include example test/examples/02_requests/02_15_early_tool_activity/02_15_early_tool_activity_test.exs
```
...
telemetry-only setting. The [output example](../02_06_output_contract/README.md) now
