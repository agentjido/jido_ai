...
The [fourteen example cases](../../../test/examples/02_requests/02_19_model_options/02_19_model_options_test.exs)
use the [public request Agent](../02_04_request_scope/agent.ex),
[native routes](../02_18_admission/agent.ex),
[stream and object Agents](../02_03_public_agent/agent.ex),
and a [real HTTP adapter](agent.ex).
They use one shared model server and the real ReqLLM client.

```sh
mix test --include example test/examples/02_requests/02_19_model_options/02_19_model_options_test.exs
```
