...
The [native Agent and controls](agent.ex)
and [13 example cases](../../../test/examples/02_requests/02_20_call_counts/02_20_call_counts_test.exs)
exercise real Agent, Session, Flow and ReqLLM work against the shared mock.

```sh
mix test test/examples/02_requests/02_20_call_counts/02_20_call_counts_test.exs --include example --seed 0
```
