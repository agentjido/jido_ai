...
and [10 example tests](../../../test/examples/02_requests/02_04_request_scope/02_04_request_scope_test.exs)
use the public Agent helpers, one mock server and real Action execution.

```sh
mix test --include example test/examples/02_requests/02_04_request_scope/02_04_request_scope_test.exs
```
