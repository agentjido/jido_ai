...
The [Agents and real tool](agent.ex)
and [16 example tests](../../../test/examples/02_requests/02_14_stream_activity/02_14_stream_activity_test.exs)
...
```sh
mix test --include example test/examples/02_requests/02_14_stream_activity/02_14_stream_activity_test.exs
```
