...
and [32 example tests](../../../test/examples/02_requests/02_12_tool_callbacks/02_12_tool_callbacks_test.exs)
use the shared model mock, real core tool execution and the production
`Jido.AI.ToolInterceptor` contract.

```sh
mix test --include example test/examples/02_requests/02_12_tool_callbacks/02_12_tool_callbacks_test.exs
```
