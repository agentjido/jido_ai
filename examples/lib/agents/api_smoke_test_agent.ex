  ...
  defmodule Tools do
    ...
    defmodule HttpGet do
      ...
      use Jido.Action,
        schema:
          Zoi.object(%{
            url: Zoi.string(description: "The URL to request"),
            headers: Zoi.map(description: "Optional headers to include") |> Zoi.default(%{}) |> Zoi.optional()
          }),
        name: "http_get",
    ...
    defmodule HttpPost do
      ...
      use Jido.Action,
        schema:
          Zoi.object(%{
            url: Zoi.string(description: "The URL to request"),
            body: Zoi.map(description: "JSON body to send") |> Zoi.default(%{}) |> Zoi.optional(),
            headers: Zoi.map(description: "Optional headers to include") |> Zoi.default(%{}) |> Zoi.optional()
          }),
        name: "http_post",
