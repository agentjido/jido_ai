...
- [Agent and operations](agent.ex)
- [Acceptance tests](../../../test/examples/01_authoring/01_02_tool_flow/01_02_tool_flow_test.exs)
...
Status: three passing example tests. This is one tool batch followed by
