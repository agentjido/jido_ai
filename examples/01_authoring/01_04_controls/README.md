...
- [Agent and control Actions](agent.ex)
- [Acceptance tests](../../../test/examples/01_authoring/01_04_controls/01_04_controls_test.exs)
...
Status: five passing example tests. These are application control Actions.
