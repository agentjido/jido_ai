...
and [example cases](../../../test/examples/03_tools/03_01_dynamic_catalog/03_01_dynamic_catalog_test.exs)
use the public `Jido.AI` facade, native DSL, core commands and the shared mock.

```sh
mix test test/examples/03_tools/03_01_dynamic_catalog/03_01_dynamic_catalog_test.exs --include example --seed 0
```
...
[03_02](../03_02_tool_context/README.md) adds persistent base tool context to the same
