...
[Agents and Action](agent.ex) and
[14 example cases](../../../test/examples/03_tools/03_02_tool_context/03_02_tool_context_test.exs)
...
uses the host binding or automatic `skills` source described in [18_02](../../18_skills/18_02_skill_authoring/README.md).
