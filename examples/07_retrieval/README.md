...
| Feature | Guide | Tests |
| --- | --- | --- |
| `07_01_memory` | [Retrieval memory and Agent enrichment](07_01_memory/README.md) | [07_01_memory_test.exs](../../test/examples/07_retrieval/07_01_memory/07_01_memory_test.exs) |

Run this group from the repository root:

```sh
mix test test/examples/07_retrieval --include example --seed 0
```
