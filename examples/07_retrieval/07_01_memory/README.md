...
[example cases](../../../test/examples/07_retrieval/07_01_memory/07_01_memory_test.exs) run the
real Actions, core Agent calls and the shared HTTP mock. Run them with:

```sh
mix test test/examples/07_retrieval/07_01_memory/07_01_memory_test.exs --include example --seed 0
```

There are 21 example cases. The Agent DSL also declares RecallMemory as a
