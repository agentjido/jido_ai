...
[tests](../../../test/examples/14_resume/14_12_terminal_state/14_12_terminal_state_test.exs) define six
example cases. Native Agent DSL uses the existing AI profile, ReAct Flow,
...
finish reasons. [02_25](../../02_requests/02_25_incomplete_response/README.md) covers that separate path.
...
```sh
mix test test/examples/14_resume/14_12_terminal_state/14_12_terminal_state_test.exs --include example --include pending_dsl --seed 0
```
