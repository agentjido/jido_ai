...
[Agent factory](agent.ex)
and [tests](../../../test/examples/14_resume/14_01_standalone_authoring/14_01_standalone_authoring_test.exs) prove
...
public Runner. [14_02](../14_02_standalone_runtime/README.md) now proves its first native
...
Twelve example cases prove aliased tool execution and exact options,
...
```sh
mix test test/examples/14_resume/14_01_standalone_authoring/14_01_standalone_authoring_test.exs --include example
```
